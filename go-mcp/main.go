// Command BreakingBadQuotes-mcp is an MCP server exposing the BreakingBadQuotes
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BreakingBadQuotes_list  — list records of an entity
//	BreakingBadQuotes_load  — load a single record of an entity
//
