...
// BreakingBadQuotes SDK rbac feature
...
class BreakingBadQuotesRbacFeature extends BreakingBadQuotesBaseFeature
{
    ...
    private function _required(BreakingBadQuotesContext $ctx): ?string
    {
    ...
    private function _reject(BreakingBadQuotesContext $ctx, string $required): void
    {
    ...
    private function _track(BreakingBadQuotesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
