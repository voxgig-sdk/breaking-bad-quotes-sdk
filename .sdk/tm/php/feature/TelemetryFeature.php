...
// BreakingBadQuotes SDK telemetry feature
...
class BreakingBadQuotesTelemetryFeature extends BreakingBadQuotesBaseFeature
{
    ...
    private function _close(BreakingBadQuotesContext $ctx, bool $ok): void
    {
