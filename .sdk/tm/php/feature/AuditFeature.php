...
// BreakingBadQuotes SDK audit feature
...
class BreakingBadQuotesAuditFeature extends BreakingBadQuotesBaseFeature
{
    ...
    private function _emit(BreakingBadQuotesContext $ctx, string $outcome): void
    {
