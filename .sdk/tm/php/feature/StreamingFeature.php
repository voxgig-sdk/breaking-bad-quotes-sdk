...
// BreakingBadQuotes SDK streaming feature
...
class BreakingBadQuotesStreamingFeature extends BreakingBadQuotesBaseFeature
{
    ...
    private function _iterate(BreakingBadQuotesResult $result): \Generator
    {
    ...
    private function _streamable(BreakingBadQuotesContext $ctx): bool
    {
