...
// BreakingBadQuotes SDK utility: result_basic

class BreakingBadQuotesResultBasic
{
    public static function call(BreakingBadQuotesContext $ctx): ?BreakingBadQuotesResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof BreakingBadQuotesError) ? $result->err->msg : (string)$result->err;
