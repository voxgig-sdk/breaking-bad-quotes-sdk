...
// BreakingBadQuotes SDK utility type

class BreakingBadQuotesUtility
{
    ...
    public static function copy(BreakingBadQuotesUtility $src): BreakingBadQuotesUtility
    {
        $u = new BreakingBadQuotesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
