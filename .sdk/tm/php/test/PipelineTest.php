...
// BreakingBadQuotes SDK pipeline test
//
...
{
    private static function utility(): BreakingBadQuotesUtility
    {
        return new BreakingBadQuotesUtility();
    }
    ...
    private static function ctx(array $over = []): BreakingBadQuotesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new BreakingBadQuotesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new BreakingBadQuotesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof BreakingBadQuotesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new BreakingBadQuotesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = BreakingBadQuotesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new BreakingBadQuotesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = BreakingBadQuotesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new BreakingBadQuotesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = BreakingBadQuotesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BreakingBadQuotesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = BreakingBadQuotesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new BreakingBadQuotesResponse([]),
            'result' => new BreakingBadQuotesResult([]),
        ]);
        [, $err] = BreakingBadQuotesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new BreakingBadQuotesSpec([]),
            'response' => null,
            'result' => new BreakingBadQuotesResult([]),
        ]);
        [, $err] = BreakingBadQuotesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new BreakingBadQuotesSpec(['step' => 's']),
            'response' => new BreakingBadQuotesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new BreakingBadQuotesResult([]),
        ]);
        [, $err] = BreakingBadQuotesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new BreakingBadQuotesSpec(['step' => 's']),
            'response' => new BreakingBadQuotesResponse(self::resp(200, ['v' => 1])),
            'result' => new BreakingBadQuotesResult([]),
        ]);
        [, $err] = BreakingBadQuotesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new BreakingBadQuotesSpec(['step' => 's']),
            'response' => new BreakingBadQuotesResponse(self::resp(200, ['v' => 2])),
            'result' => new BreakingBadQuotesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        BreakingBadQuotesMakeResponse::call($ctx);
    ...
    {
        $preset = new BreakingBadQuotesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new BreakingBadQuotesSpec([]),
            'response' => new BreakingBadQuotesResponse([]),
            'result' => new BreakingBadQuotesResult([]),
        ...
        [$got, $err] = BreakingBadQuotesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new BreakingBadQuotesResult([])]);
        [, $err] = BreakingBadQuotesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new BreakingBadQuotesSpec([]), 'result' => null]);
        [, $err] = BreakingBadQuotesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BreakingBadQuotesSpec(['step' => 's']),
            'result' => new BreakingBadQuotesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new BreakingBadQuotesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BreakingBadQuotesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BreakingBadQuotesSpec(['step' => 's']),
            'result' => new BreakingBadQuotesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new BreakingBadQuotesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BreakingBadQuotesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BreakingBadQuotesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new BreakingBadQuotesSpec([]),
            'result' => new BreakingBadQuotesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = BreakingBadQuotesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BreakingBadQuotesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new BreakingBadQuotesError('boom', 'boom');
        $utility->fetcher = function (BreakingBadQuotesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BreakingBadQuotesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = BreakingBadQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (BreakingBadQuotesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = BreakingBadQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(BreakingBadQuotesResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        BreakingBadQuotesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (BreakingBadQuotesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BreakingBadQuotesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = BreakingBadQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new BreakingBadQuotesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new BreakingBadQuotesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = BreakingBadQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = BreakingBadQuotesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = BreakingBadQuotesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new BreakingBadQuotesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, BreakingBadQuotesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new BreakingBadQuotesResult(['ok' => false])]);
        $this->expectException(BreakingBadQuotesError::class);
        BreakingBadQuotesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new BreakingBadQuotesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', BreakingBadQuotesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        BreakingBadQuotesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new BreakingBadQuotesBaseFeature();
        $b = new BreakingBadQuotesBaseFeature();
        BreakingBadQuotesFeatureAdd::call($ctx, $a);
        BreakingBadQuotesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): BreakingBadQuotesBaseFeature
    {
        $f = new BreakingBadQuotesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        BreakingBadQuotesFeatureAdd::call($ctx, self::named_feature('a'));
        BreakingBadQuotesFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        BreakingBadQuotesFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        BreakingBadQuotesFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        BreakingBadQuotesFeatureAdd::call($ctx, $replace);
        ...
        BreakingBadQuotesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): BreakingBadQuotesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new BreakingBadQuotesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BreakingBadQuotesPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        BreakingBadQuotesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new BreakingBadQuotesResponse(['headers' => null]),
            'result' => new BreakingBadQuotesResult([]),
        ]);
        BreakingBadQuotesResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        BreakingBadQuotesResultBody::call($ctx);
