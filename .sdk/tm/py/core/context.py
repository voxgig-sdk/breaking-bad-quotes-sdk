...
class BreakingBadQuotesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = BreakingBadQuotesControl()
        ...
        if isinstance(sp, BreakingBadQuotesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BreakingBadQuotesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BreakingBadQuotesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return BreakingBadQuotesOperation({})
    ...
    def make_error(self, code, msg):
        return BreakingBadQuotesError(code, msg, self)
