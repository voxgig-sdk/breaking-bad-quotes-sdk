...
function runner.env_override(m)
  local live = runner.getenv("BREAKINGBADQUOTES_TEST_LIVE")
  local override = runner.getenv("BREAKINGBADQUOTES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("BREAKINGBADQUOTES_TEST_EXPLAIN")
