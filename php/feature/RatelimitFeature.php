...
// BreakingBadQuotes SDK ratelimit feature
...
class BreakingBadQuotesRatelimitFeature extends BreakingBadQuotesBaseFeature
{
    ...
    private function _acquire(BreakingBadQuotesContext $ctx): void
    {
    ...
    private function _track(BreakingBadQuotesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
