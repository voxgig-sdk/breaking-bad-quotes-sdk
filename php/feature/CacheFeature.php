...
// BreakingBadQuotes SDK cache feature
...
class BreakingBadQuotesCacheFeature extends BreakingBadQuotesBaseFeature
{
    ...
    private function _through(BreakingBadQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
