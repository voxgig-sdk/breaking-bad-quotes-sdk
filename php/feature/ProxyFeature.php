...
// BreakingBadQuotes SDK proxy feature
...
class BreakingBadQuotesProxyFeature extends BreakingBadQuotesBaseFeature
{
    ...
    public function init(BreakingBadQuotesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BreakingBadQuotesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
