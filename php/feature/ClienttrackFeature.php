...
// BreakingBadQuotes SDK clienttrack feature
...
class BreakingBadQuotesClienttrackFeature extends BreakingBadQuotesBaseFeature
{
    ...
    public function PostConstruct(BreakingBadQuotesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BreakingBadQuotes-SDK';
