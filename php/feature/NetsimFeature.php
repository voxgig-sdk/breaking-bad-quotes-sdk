...
// BreakingBadQuotes SDK netsim feature
...
class BreakingBadQuotesNetsimFeature extends BreakingBadQuotesBaseFeature
{
    ...
    private function _simulate(BreakingBadQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BreakingBadQuotesContext $ctx, array $applied): void
    {
        $client = $this->client;
