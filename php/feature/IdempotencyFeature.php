...
// BreakingBadQuotes SDK idempotency feature
...
class BreakingBadQuotesIdempotencyFeature extends BreakingBadQuotesBaseFeature
{
    ...
    private function _mutating(BreakingBadQuotesContext $ctx): bool
    {
