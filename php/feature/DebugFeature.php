...
// BreakingBadQuotes SDK debug feature
...
class BreakingBadQuotesDebugFeature extends BreakingBadQuotesBaseFeature
{
    ...
    private function _finish(BreakingBadQuotesContext $ctx, bool $ok): void
    {
