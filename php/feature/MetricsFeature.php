...
// BreakingBadQuotes SDK metrics feature
...
class BreakingBadQuotesMetricsFeature extends BreakingBadQuotesBaseFeature
{
    ...
    private function _record(BreakingBadQuotesContext $ctx, bool $ok): void
    {
