...
// BreakingBadQuotes SDK timeout feature
...
class BreakingBadQuotesTimeoutFeature extends BreakingBadQuotesBaseFeature
{
    ...
    private function _with_timeout(BreakingBadQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BreakingBadQuotesContext $_ctx, float $ms): void
    {
        $client = $this->client;
