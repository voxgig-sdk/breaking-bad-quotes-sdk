...
// BreakingBadQuotes SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BreakingBadQuotesSDK::test)
...
{
    private const SDK_CLASS = 'BreakingBadQuotesSDK';
    ...
    private const SDK_BASE = 'breakingbadquotes_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../breakingbadquotes_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
