...
// BreakingBadQuotes SDK utility: fetcher

class BreakingBadQuotesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BreakingBadQuotesSDK/1.0)';
    ...
    public static function call(BreakingBadQuotesContext $ctx, string $fullurl, array $fetchdef): array
    {
