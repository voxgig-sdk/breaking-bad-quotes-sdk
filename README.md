...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/breaking-bad-quotes` | `npm install @voxgig-sdk/breaking-bad-quotes` |
| Python | `voxgig-sdk-breaking-bad-quotes` | `pip install voxgig-sdk-breaking-bad-quotes` |
| PHP | `voxgig-sdk/breaking-bad-quotes` | `composer require voxgig-sdk/breaking-bad-quotes` |
| Golang | `github.com/voxgig-sdk/breaking-bad-quotes-sdk/go` | `go get github.com/voxgig-sdk/breaking-bad-quotes-sdk/go` |
| Ruby | `voxgig-sdk-breaking-bad-quotes` | `gem install voxgig-sdk-breaking-bad-quotes` |
| Lua | `voxgig-sdk-breaking-bad-quotes` | `luarocks install voxgig-sdk-breaking-bad-quotes` |
