...
// `class AdviceEntity extends BreakingBadQuotesEntityBase<Advice>`.
class BreakingBadQuotesEntityBase<D = any> {
  name = ''
  name_ = ''
  Name = ''

  _client: BreakingBadQuotesSDK
  _utility: Utility
  _entopts: any
  _data: any
  _match: any
  ...
  constructor(client: BreakingBadQuotesSDK, entopts: any) {
    entopts = entopts || {}
