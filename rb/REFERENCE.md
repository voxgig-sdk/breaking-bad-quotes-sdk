# BreakingBadQuotes Ruby SDK Reference

Complete API reference for the BreakingBadQuotes Ruby SDK.
...
```ruby
require_relative 'breaking-bad-quotes_sdk'
...
#### `BreakingBadQuotesSDK.test(testopts = nil, sdkopts = nil)`
