...
#      offline in seeded test mode (BreakingBadQuotesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "BreakingBadQuotes_sdk.rb")
  SDK_CLASS = "BreakingBadQuotesSDK"
  ...
  SDK_BASE = "BreakingBadQuotes_sdk"
