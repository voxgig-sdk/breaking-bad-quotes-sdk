...
AQL-driven CLI and REPL for the BreakingBadQuotes SDK. Positional arguments are
...
```sh
go build -o breaking-bad-quotes-cli ./...
```
...
./breaking-bad-quotes-cli load 1 quote
./breaking-bad-quotes-cli load '{id:1}' quote
