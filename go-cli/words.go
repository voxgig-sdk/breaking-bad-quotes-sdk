...
func registerSDKWords(r *eng.Registry, client *sdk.BreakingBadQuotesSDK) {
...
func runOp(client *sdk.BreakingBadQuotesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
