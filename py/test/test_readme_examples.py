# BreakingBadQuotes SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from breakingbadquotes_sdk import BreakingBadQuotesSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"BreakingBadQuotesSDK": BreakingBadQuotesSDK, "os": os}
        try:
