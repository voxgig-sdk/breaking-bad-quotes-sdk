# BreakingBadQuotes SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BreakingBadQuotesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BreakingBadQuotesSDK(...) and BreakingBadQuotesSDK.test(...) become
#      BreakingBadQuotesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "breakingbadquotes_sdk"
_SDK_CLASS = "BreakingBadQuotesSDK"
